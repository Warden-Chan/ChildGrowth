...
- (IBAction)loginBtnClick:(UIButton *)sender {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        if([self.accoutTextF.text isEqualToString:@"18868824160"] && [self.pwdTextF.text isEqualToString:@"123"]) {
            //隐藏HUD
...
//    UIView *nibView = [[[NSBundle mainBundle] loadNibNamed:@"One" owner:nil options:nil] lastObject];
