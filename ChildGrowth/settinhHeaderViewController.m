...
-(void)createTextFields
{
    ...
    bgView=[[UIView alloc]initWithFrame:CGRectMake(0, 180,frame.size.width, 150)];
...
-(void)createUI
{
    ...
    UILabel *label=[[UILabel alloc]initWithFrame:CGRectMake((self.view.frame.size.width-120)/2, 120, 120, 80)];
    label.text=@"点击设置用户头像";
